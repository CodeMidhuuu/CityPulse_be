...
SECRET_KEY = 'django-insecure-@0l_1v$evy!%mr)&hn&gwq6d$$z8_-v7vy=4d+_5%q1r5r4s9j'
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': False,  # Do not rotate refresh tokens automatically
    'BLACKLIST_AFTER_ROTATION': False,  # Option to blacklist tokens after rotation
    'ALGORITHM': 'HS256',  # Algorithm used to encode the token
    'SIGNING_KEY': 'your-secret-key',  # Secret key used to sign the JWT tokens
}
